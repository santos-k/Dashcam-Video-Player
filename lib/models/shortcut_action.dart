...
const actionDisplayNames = <ShortcutAction, String>{
  ...
  ShortcutAction.layoutSideBySide: 'Side by side',
  ShortcutAction.layoutStacked:    'Stacked',
  ShortcutAction.layoutPip:        'PIP (toggle primary)',
  ShortcutAction.layoutFrontOnly:  'Front only',
  ShortcutAction.layoutBackOnly:   'Back only',
...
const _defaults = <ShortcutAction, KeyBinding>{
  ...
  ShortcutAction.layoutStacked:    KeyBinding('digit2'),
  ShortcutAction.layoutPip:        KeyBinding('digit3'),
  ShortcutAction.layoutFrontOnly:  KeyBinding('digit4'),
  ShortcutAction.layoutBackOnly:   KeyBinding('digit5'),
